...
namespace Nutrition_Tracker.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FdcId = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    GramsConsumed = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserFoodLogs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserFoodLogs_AspNetUsers_ApplicationUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserFoodLogs_ApplicationUserId",
                table: "UserFoodLogs",
